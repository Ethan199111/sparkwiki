...
object HiggsExtend {
  ...
  def main(args: Array[String]): Unit = {
    ...
    MLUtils.saveAsLibSVMFile(train2.repartition(2048), "/tmp/zrf/HIGGS-DENSEEXT-Train")
    MLUtils.saveAsLibSVMFile(test2.repartition(512), "/tmp/zrf/HIGGS-DENSEEXT-Test")
    ...
    MLUtils.saveAsLibSVMFile(train3.repartition(512), "/tmp/zrf/HIGGS-SPARSEEXT-Train")
    MLUtils.saveAsLibSVMFile(test3.repartition(128), "/tmp/zrf/HIGGS-SPARSEEXT-Test")
