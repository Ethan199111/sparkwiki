...
/**
  * spark-submit --class example.HiggsDenseTest --master yarn-client --driver-memory 8G --executor-memory 2G --num-executors 32 --jars spark-gbm/target/spark-gbm-2.3.0.jar examples/target/examples-2.3.0.jar 2>log
  */
object HiggsDenseTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    gbmc.setBoostType("gbtree")
      ...
      .setMaxBins(128)
      .setMinNodeHess(1.0)
      .setSubSampleRate(0.8)
      .setColSampleRateByTree(1.0)
      .setColSampleRateByLevel(1.0)
      .setRegAlpha(0.1)
      .setRegLambda(1.0)
